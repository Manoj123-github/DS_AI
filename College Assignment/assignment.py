# -*- coding: utf-8 -*-
"""
Created on Thu May 20 20:48:20 2021
...
# read dataset
df = pd.read_csv('C:/Py-ML/Assignment/house-data.csv')
...
# class count plot
# change as required
colNames=['bedrooms','bathrooms','floors','waterfront','view','condition','grade',	]
...
# change as required
print("\n*** Drop Cols ***")
allCols.remove('sqft_lot')
allCols.remove('floors')
print(allCols)
...
dfp = pd.read_csv('C:/Py-ML/Assignment/house-data-prd.csv')
