# -*- coding: utf-8 -*-
"""
Created on Sat Jun 19 14:28:09 2021
...
df = pd.read_csv('C:/Py-ML/glassm-data.csv')
...
df['Ca']=np.where(df['Ca']=='',None,df['Ca'])
...
dfp = pd.read_csv('C:/Py-ML/glassm-data-prd.csv')
print(dfp.info())
