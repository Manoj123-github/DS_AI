...
for i in range(0,len(X_test)):
    p_test = np.append(p_test, statistics.mean([xvPredict[0][i], xvPredict[1][i], xvPredict[2][i]]))
print(p_test)     
print("Done ...")
...
for i in range(0,len(X_pred)):
    p_pred = np.append(p_pred, statistics.mean([xvPredict[0][i], xvPredict[1][i], xvPredict[2][i]]))
print(p_pred)     
print("Done ...")
