...
for i in range(0,len(X_test)):
    p_test = np.append(p_test, round(xvPredict[0][i]*0.3 + xvPredict[1][i]*0.3 + xvPredict[2][i]*0.4,0) )
print(p_test)     
print("Done ...")
...
for i in range(0,len(X_pred)):
    p_pred = np.append(p_pred, round(xvPredict[0][i]*0.3 + xvPredict[1][i]*0.3 + xvPredict[2][i]*0.4,0) )
print(p_pred)     
print("Done ...")
