...
# read dataset
df = pd.read_csv('C:/Users/Manoj Yadav/Desktop/Part II/ML II/Ensenble algorithms/boston-housing.dat', header=None, delimiter=r"\s+", names=colNames)
print("Done ...")
...
lModels.append(("DecisionTreeRegression  ",DecisionTreeRegressor(random_state=707)))
...
lModels.append(("XGBoost Regressor ",xgb.XGBRegressor(booster='gblinear', objective ='reg:linear', seed=707)))
lModels.append(("RandomForestRegressor ",RandomForestRegressor(random_state = 707) ))
...
# read dataset
colNames = ['CRIM', 'ZN', 'INDUS', 'CHAS', 'NOX', 'RM', 'AGE', 'DIS', 'RAD', 'TAX', 'PTRATIO', 'B', 'LSTAT', 'MEDV']
dfp = pd.read_csv('C:/Users/Manoj Yadav/Desktop/Part II/ML II/Ensenble algorithms/boston-housing-prd.dat', header=None, delimiter=r"\s+", names=colNames)
