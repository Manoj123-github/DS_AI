# -*- coding: utf-8 -*-
"""
Created on Sun Sep 26 08:30:08 2021
...
# read dataset
df = pd.read_csv('C:/Users/Manoj Yadav/Desktop/Part II/ML II/Regression/cancer-deaths.csv', encoding = "ISO-8859-1")
##############################################################
...
# change as required
print("\n*** Drop Cols ***")
df = df.drop(['ser','binnedInc','Geography'], axis=1)
print("Done ...")
...
# handle nulls
colNames = ['PctSomeCol18_24','PctEmployed16_Over','PctPrivateCoverageAlone']
for colName in colNames:
    colType =  df[colName].dtype  
...
allCols.remove('medIncome')
allCols.remove('studyPerCap')
allCols.remove('MedianAge')
allCols.remove('MedianAgeMale')
allCols.remove('MedianAgeFemale')
allCols.remove('AvgHouseholdSize')
allCols.remove('PctAsian')
allCols.remove('PctBlack')
allCols.remove('PctSomeCol18_24')
allCols.remove('PctBachDeg18_24')
allCols.remove('PctUnemployed16_Over')
allCols.remove('PctPrivateCoverageAlone')
allCols.remove('PctPublicCoverage')
allCols.remove('PctPublicCoverageAlone')
print(allCols)
...
# read dataset
dfp = pd.read_csv('C:/Users/Manoj Yadav/Desktop/Part II/ML II/Regression/cancer-deaths-prd.csv', encoding = "ISO-8859-1")
print("\n*** Structure ***")
print(dfp.info())
...
print("Done ... ")
# handle nulls
colNames = ['PctSomeCol18_24','PctEmployed16_Over','binnedInc']
for colName in colNames:
